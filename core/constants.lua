...
local left, right, top, bottom = C_Minimap.GetObjectIconTextureCoords(4772) --MagePortalAlliance
local left2, right2, top2, bottom2 = C_Minimap.GetObjectIconTextureCoords(4773) --MagePortalHorde
