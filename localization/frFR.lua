local L = LibStub("AceLocale-3.0"):NewLocale("HandyNotes_Oribos", "frFR", false, true)
...
L["config_plugin_desc"] = "Affiche les emplacements des PNJ et des points d'intérêt à Oribos sur la carte du monde et la mini-carte."
